        ...
        <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
                        class="fa-solid fa-users"></i></i>Users</a>
            ...
            </a> <a href="{{ route('bookingtable') }}" class="nav-item nav-link"><i
                    class="fa-solid fa-table"></i>Booking</a>
            ...
            <div class="navbar-nav w-100">
                @if (auth()->check() && auth()->user()->role === 'admin')
                    <a href="{{ route('admin.doctors.create') }}" class="nav-item nav-link "><i
                            class="fa fa-tachometer-alt me-2"></i>Add Doctor</a>
